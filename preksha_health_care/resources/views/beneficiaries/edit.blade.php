                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-check-inline">
                                        <input id="male" type="radio" class="form-check-input{{ $errors->has('gender') ? ' is-invalid' : '' }}" name="gender" value="Male" @if(old('gender')) checked @endif>
                                        <label class="form-check-label" for="male">Male</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input id="female" type="radio" class="form-check-input{{ $errors->has('gender') ? ' is-invalid' : '' }}" name="gender" value="Female" @if(!old('gender')) checked @endif>
